...
def Start_Student(json_big_data):
    while True:
        ...
        if initial_number == 1:  ## 학생 정보 입력
            ...
            Class_Code(json_big_data, student_data, total_course_info, now_course_info_list,
                       now_course_info_dict)  ## 강의 코드 - 강의명 - 강사 이름 - 개강일 - 종료일.. 입력 함수
...
def Class_Code(json_big_data, student_data, total_course_info, now_course_info_list,
               now_course_info_dict):  ## 수강 정보 입력 함수
