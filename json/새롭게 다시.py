...
def Student_Info(search_student, json_big_data):      ## 학생 정보조회 출력 함수 1-1
...
def Student_Info_Print(search_student, json_big_data, search_info, now_course_info):        ## 학생 정보조회 출력 함수 1-2
