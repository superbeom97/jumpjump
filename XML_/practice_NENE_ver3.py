...
nene_file = "nene_"
csv = ".csv"
make_time_first = time.strftime('%X ', time.localtime(time.time()))
make_time = make_time_first.replace(":", " ")
record_limit = 3
...
def make_nene(dir_index) :
    destination_csv = dir_name + dir_delimiter + nene_dir + str(dir_index) + dir_delimiter + nene_file + make_time + csv
