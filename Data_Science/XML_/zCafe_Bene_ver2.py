### 웹 스크롤링해서 매장 정보와 갯수/점유율을 한 파일로 함께 저장하는 버전
...
store_result.append([" "])
store_result.append(["전국 단위별 매장 갯수"] + ["전국 내 지역별 카페베네 점유율"])
store_result.append(["서울 내의 카페베네 갯수 : %s개" % Seoul_number] + ["전국 대비 서울의 카페베네 점유율 : %0.2f%%" % Seoul_percent])
store_result.append(["부산 내의 카페베네 갯수 : %s개" % Busan_number] + ["전국 대비 부산의 카페베네 점유율 : %0.2f%%" % Busan_percent])
store_result.append(["대구 내의 카페베네 갯수 : %s개" % Daegu_number] + ["전국 대비 대구의 카페베네 점유율 : %0.2f%%" % Daegu_percent])
store_result.append(["대전 내의 카페베네 갯수 : %s개" % Daejeon_number] + ["전국 대비 대전의 카페베네 점유율 : %0.2f%%" % Daejeon_percert])
store_result.append(["인천 내의 카페베네 갯수 : %s개" % Incheon_number] + ["전국 대비 인천의 카페베네 점유율 : %0.2f%%" % Incheon_percert])
store_result.append(["광주 내의 카페베네 갯수 : %s개" % Goangju_number] + ["전국 대비 광주의 카페베네 점유율 : %0.2f%%" % Goangju_percert])
store_result.append(["울산 내의 카페베네 갯수 : %s개" % Ulsan_number] + ["전국 대비 울산의 카페베네 점유율 : %0.2f%%" % Ulsan_percert])
store_result.append(["제주 내의 카페베네 갯수 : %s개" % Jeju_number] + ["전국 대비 제주의 카페베네 점유율 : %0.2f%%" % Jeju_percert])
store_result.append(["경기 내의 카페베네 갯수 : %s개" % Gyeonggi_number] + ["전국 대비 경기의 카페베네 점유율 : %0.2f%%" % Gyeonggi_percert])
store_result.append(["강원 내의 카페베네 갯수 : %s개" % Gangwon_number] + ["전국 대비 강원의 카페베네 점유율 : %0.2f%%" % Gangwon_percert])
store_result.append(["충북 내의 카페베네 갯수 : %s개" % ChungcheongNorth_number] + ["전국 대비 충북의 카페베네 점유율 : %0.2f%%" % ChungcheongNorth_percert])
store_result.append(["충남 내의 카페베네 갯수 : %s개" % ChungcheongSouth_number] + ["전국 대비 충남의 카페베네 점유율 : %0.2f%%" % ChungcheongNorth_percert])
store_result.append(["전북 내의 카페베네 갯수 : %s개" % JeonlaNorth_number] + ["전국 대비 전북의 카페베네 점유율 : %0.2f%%" % JeonlaNorth_percert])
store_result.append(["전남 내의 카페베네 갯수 : %s개" % JeonlaSouth_number] + ["전국 대비 전남의 카페베네 점유율 : %0.2f%%" % JeonlaSouth_percert])
store_result.append(["경북 내의 카페베네 갯수 : %s개" % GyeongsangNorth_number] + ["전국 대비 경북의 카페베네 점유율 : %0.2f%%" % GyeongsangNorth_percert])
store_result.append(["경남 내의 카페베네 갯수 : %s개" % GyeongsangSouth_number] + ["전국 대비 경남의 카페베네 점유율 : %0.2f%%" % GyeongsangSouth_percert])
